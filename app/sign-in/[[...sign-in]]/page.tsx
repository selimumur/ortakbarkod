...
export default function Page() {
    ...
    const slides = [
        {
            id: 1,
            title: "YENİ: Arbitraj Modülü Yayında!",
            desc: "Global pazarlardaki fiyat farklarını anlık takip edin ve kar fırsatlarını yakalayın.",
        ...
        },
        {
            ...
            desc: "Trendyol, Hepsiburada ve Amazon mağazalarınızı tek ekrandan yönetin. Stok ve fiyatlar otomatik senkronize olsun.",
        ...
        },
        {
            ...
            desc: "Verileriniz bulut tabanlı şifreli sunucularımızda güvende. KVKK uyumlu ve 7/24 yedekli.",
                ...
                <div className="w-full max-w-[400px] relative z-10">
                    ...
                    <div className="lg:hidden mt-8 text-center px-4">
                        <div className="flex items-center justify-center gap-2 text-indigo-400 text-xs font-medium bg-indigo-500/10 p-3 rounded-lg border border-indigo-500/20">
                            <Info size={14} />
                            <span>Yeni özellikler ve güncellemeler için paneli takip edin.</span>
                        </div>
                    </div>
