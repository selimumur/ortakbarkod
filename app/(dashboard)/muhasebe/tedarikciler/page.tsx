...
import { Building2, Plus, Search, Phone, Mail, Trash2, Edit, Save, RefreshCw, X, Wallet, ArrowRight } from 'lucide-react';
import { toast } from 'sonner';
import { useRouter } from 'next/navigation';
import { getSuppliersAction, upsertSupplierAction, deleteSupplierAction, type Supplier } from '@/app/actions/supplierActions';
...
export default function SuppliersPage() {
   ...
   async function fetchSuppliers() {
      ...
      try {
         ...
         toast.error("Tedarikçiler yüklenirken hata oluştu: " + error.message);
      } finally {
         setLoading(false);
      }
   }
   ...
   const openModal = (supplier: Supplier | null = null) => {
      if (supplier) {
         ...
         setFormData({ id: undefined, name: "", contact_person: "", phone: "", email: "", tax_number: "", balance: 0 });
         setIsEditing(false);
      }
      setIsModalOpen(true);
   };
